    ...
    module Azure
      ...
      class ProviderArm < ::PuppetX::Puppetlabs::Azure::ProviderBase
        ...
        def get_deployments(resource_group) # rubocop:disable Metrics/AbcSize
          ...
          while !result.next_link.nil? && !result.next_link.empty?
        ...
        def build_image_reference(args)
          build(::Azure::ARM::Compute::Models::ImageReference, publisher: args[:image].split(':')[0],
        ...
        def build_template_deployment(args)
          build(::Azure::ARM::Resources::Models::Deployment, properties: build_template_deployment_properties(args))
        end
        ...
        def build_network_profile(args)
          build(::Azure::ARM::Compute::Models::NetworkProfile, network_interfaces: [
                  create_network_interface(args, create_subnet(create_virtual_network(args), args))])
        end
