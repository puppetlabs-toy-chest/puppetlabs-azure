...
Puppet::Type.newtype(:azure_vm) do
  ...
  newproperty(:user, :parent => PuppetX::Property::String) do
    desc 'User name for the virtual machine.'
  end

  newproperty(:image, :parent => PuppetX::Property::String) do
  ...
  newproperty(:storage_account, :parent => PuppetX::Property::String) do
    desc 'The storage account to associate the virtual machine with.'
  end

  newproperty(:winrm_transport, :parent => PuppetX::Property::String, :array_matching => :all) do
    desc 'A list of transport protocols for WINRM.'
  end

  newproperty(:winrm_https_port, :parent => PuppetX::Property::PositiveInteger) do
    desc 'The port number of WINRM https communication.'
  end

  newproperty(:winrm_http_port, :parent => PuppetX::Property::PositiveInteger) do
    desc 'The port number of WINRM http communication.'
  end

  newproperty(:cloud_service, :parent => PuppetX::Property::String) do
    desc 'The name of the associated cloud service.'
  end

  newproperty(:deployment, :parent => PuppetX::Property::String) do
    desc 'The name for the deployment.'
  end

  newproperty(:tcp_endpoints, :parent => PuppetX::Property::String, :array_matching => :all) do
    desc 'The internal port and external/public port separated by a colon.'
  end
  ...
  newproperty(:ssh_port, :parent => PuppetX::Property::PositiveInteger) do
    desc 'The port number for SSH.'
  end

  newproperty(:vm_size, :parent => PuppetX::Property::String) do
    desc 'The size of the virtual machine instance.'
  end

  newproperty(:affinity_group, :parent => PuppetX::Property::String) do
    desc 'The affinity group to be used for the cloud service and the storage account if these do not exist.'
  end

  newproperty(:virtual_network, :parent => PuppetX::Property::String) do
    desc 'The virtual network to which the virtual machine should be connected.'
  end

  newproperty(:subnet, :parent => PuppetX::Property::String) do
    desc 'The subnet to which the virtual machine should be associated.'
  end

  newproperty(:availability_set, :parent => PuppetX::Property::String) do
    desc 'The availability set for the virtual machine.'
  end

  newproperty(:reserved_ip, :parent => PuppetX::Property::String) do
